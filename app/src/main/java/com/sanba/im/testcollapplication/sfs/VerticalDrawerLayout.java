package com.sanba.im.testcollapplication.sfs;

/**
 * 作者:Created by 简玉锋 on 2017/2/24 11:14
 * 邮箱: jianyufeng@38.hn
 */
...
public class VerticalDrawerLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        if (changed) {
            MarginLayoutParams params = (MarginLayoutParams) mDrawerView.getLayoutParams();
            mDrawerView.layout(params.leftMargin, mCurTop + params.topMargin,
             ...
             params = (MarginLayoutParams) mContentView.getLayoutParams();
